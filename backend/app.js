...
app.listen(PORT, () => {
  ...
  console.log(`Socket.io activo para quizzes interactivos`);
  console.log(`Entorno: ${process.env.NODE_ENV || 'development'}`);
  console.log('Rutas disponibles:');
  console.log('   - POST /api/auth/login');
  console.log('   - GET  /api/users/profesores (coordinador)');
  console.log('   - POST /api/users/profesores (coordinador)');
  console.log('   - GET  /api/materias');
  console.log('   - GET  /api/materias/profesor/:id (coordinador)');
  console.log('   - POST /api/materias/asignar (coordinador)');
});
