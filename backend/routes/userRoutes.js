...
// En userRoutes.js, CAMBIA el nombre de la ruta:

/**
 * @swagger
 * /api/users/profesores/{id}/reset-password:
 *   put:
 *     summary: Cambiar contraseña de un profesor (solo coordinador)
 *     tags: [Gestión de Usuarios]
 *     security:
 *       - bearerAuth: []
 *     parameters:
 ...
 *     responses:
 *       200:
 *         description: Contraseña del profesor cambiada exitosamente
 *       400:
...
// PUT /api/users/profesores/:id/reset-password - Cambiar contraseña de profesor (solo coordinador)
router.put('/profesores/:id/reset-password', (req, res, next) => {
  console.log('🔔 RUTA LLAMADA: Cambiar contraseña profesor');
